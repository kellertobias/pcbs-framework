...
npx @tobisk/pcbs parts --value <e.g. 10k> --footprint <e.g. 0603 >
...
- **parts**: Searches for JLC parts. either provide footprint and value or open it in interactive mode. Also available: --json, --debug, --basic-only
